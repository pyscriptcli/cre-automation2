...
def replace_text_in_paragraph(paragraph, text_inputs):
    ...
    # Store the original complete text with all spacing
    ...
    # IMPORTANT: Preserve exact spacing - DO NOT compress spaces
    # Only remove leading/trailing spaces if they exist
    modified_complete_text = modified_complete_text.strip()
    
    # Apply the modified text to the first run while preserving formatting
    if len(paragraph.runs) > 0:
        # Get the first run and store its formatting
