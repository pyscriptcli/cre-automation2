...
POI_CONFIG = {
    ...
    "RETAIL, SHOPS & CONSUMER SERVICES": [
    ...
    "HEALTH & EMERGENCY SERVICES": [
        ...
        ['Firestation', '"amenity"="fire_station"'], # Kept separate duplicate to respect NO-REMOVAL rule
        ['Police', '"amenity"="police"'],           # Kept separate duplicate to respect NO-REMOVAL rule
        ['Hospital Adv', '"amenity"="hospital"'],    # Kept separate duplicate to respect NO-REMOVAL rule
