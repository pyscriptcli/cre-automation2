...
# -----------------------------------------------------------------------------
# ARCHITECTURAL FIX: Instantiated globally at top-level script lifecycle execution context
scan_mode = "Radius"
...
# SCOPE ALIGNMENT FIX: Safe variable resolution checks to cleanly load contextual anchor definitions
if scan_mode != "Radius" and pts_active:
