...
st.markdown("""
    ...
    hr { margin: 10px 0; border-bottom: 1.5px solid black; }
    </style>
...
if 'table_data' not in st.session_state:
    st.session_state.table_data = pd.DataFrame([{"ITEMS/DESCRIPTION": "", "QTY": 0.0, "UNIT": "", "UNIT PRICE": 0.0, "AMOUNT": 0.0} for _ in range(7)])
...
with col_sig2:
    ...
    app_remarks = st.text_input("Remarks:", key="app_remarks_app")
